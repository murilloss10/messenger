<div class="h-full w-full flex flex-col items-end">
    <div class="h-full w-full p-2" x-data="{
        isViewed() {
    ...
    <div class="w-full flex justify-center">
        <form wire:submit="sendNewMessage"
            class="max-h-44 w-full md:w-4/5 flex fixed bottom-0 items-end justify-between rounded-t-lg dark:bg-neutral-950 border-t">
