<div class="h-full w-full flex flex-col items-end">
            ...
            @foreach ($this->allMessages as $key => $item)
                ...
                @else
                    ...
                    <div class="flex items-end gap-2 other-message" wire:key="message-{{ $key }}">
                        <div
                            class="mr-auto flex max-w-[70%] flex-col gap-2 rounded-r-xl rounded-tl-xl bg-neutral-200 p-4 text-neutral-600 md:max-w-[60%]">
                            <div class="text-sm">
                                {!! nl2br(e($item['content'])) !!}
                            </div>
                            <span
    ...
    <div class="w-full flex justify-center">
        <form wire:submit="sendNewMessage"
            class="max-h-44 w-full md:w-4/5 flex fixed bottom-0 items-end justify-between rounded-t-lg border-t border-slate-400">
