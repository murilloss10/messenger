...
<body>
    ...
    <div x-data="{ showSidebar: true }" class="relative flex w-full flex-col md:flex-row">
        ...
        <nav x-cloak
            class="fixed left-0 z-20 flex w-2/3 h-svh flex-col bg-neutral-100 p-4 transition-transform duration-300 md:w-1/5 md:translate-x-0 md:relative dark:bg-neutral-800"
            x-bind:class="{
            ...
            <a href="#" class="ml-2 w-fit text-2xl font-bold text-neutral-900 dark:text-neutral-100">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 376 155" fill="none" class="w-24"
                    ...
                    <path
                        ...
                        class="fill-neutral-900 dark:fill-neutral-100"></path>
                    <path
            ...
            <div class="flex flex-col gap-2 overflow-y-auto scrollbar-thin pb-1">
                @for ($i = 0; $i < 30; $i++)
                    <a href="" class="flex items-center rounded-none gap-2 ps-1 dark:text-neutral-400 dark:hover:bg-white/5 dark:hover:text-neutral-100 text-white">
                        ...
                        <div>
                            <p class="text-md font-semibold">+553199887766</p>
                            <p class="text-sm">Minha última mensagem</p>
                        </div>
                    </a>
                @endfor
            </div>
